	...
	public void enterAction(String guess) {
		...
		else if (gameOver && scoreDisplay == false) 
      {
         ...
         // System.out.println(solution);
             ...
             * HINT:
             * Use a for loop to compare each word in FIVE_LETTER_WORDS to the guess parameter
            */ 
            ...
            /* TODO - Milestone 3 - Color the boxes based on whether the letter is in the correct
             * position, in the wrong position, or not in the word at all. use WordleGWindow.CORRECT_COLOR,
             * WordleGWindow.PRESENT_COLOR, and WordleGWindow.MISSING_COLOR. Read the assignment details
             * for details on how to do this. You will need to loop in order to compare individual characters.
			    * This is the big one. Read the spec for guidance.
             */
             ...
             if (gw.getCurrentRow() < 6 && wordPresent && currentGuess.length == 5 && !maxRowsUsed)
             {
               ...
               // avoid out of bounds exception error
